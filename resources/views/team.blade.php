...
@section('container')
    <div class="px-4 py-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-16">
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p class="dark:text-gray-400 text-base text-gray-700 md:text-lg italic font-bold">
                "Ada kekuatan yang sangat besar ketika sekelompok orang dengan minat yang sama berkumpul untuk bekerja
                menuju tujuan yang sama."
            </p><span class="text-gray-300 dark:text-gray-100"> - Idowu Koyenikan - </span>
        </div>
        <div class="flex flex-row flex-wrap-reverse justify-center mt-8">
            @foreach ($users as $user)
                {{-- <div class="flex flex-col items-center w-1/2 md:w-1/4 dark:bg-gray-900 rounded-lg p-4 shadow-md  ">
                    <div class=" flex w-full justify-center">
                        <img class="md:-mt-14 object-cover w-20 h-20 mb-2 rounded-full shadow"
                            src="{{ isset($user->photo_profile) ? asset('storage/' . $user->photo_profile) : 'https://dummyimage.com/200x200' }}"
                            alt="Person" />
                    </div>

                    <div class="flex flex-col text-center border-b pb-1 border-gray-100">
                    ...
                    <div class="flex flex-row space-x-2 text-gray-900 dark:text-gray-200 mt-1 ">
                        <a href="#" title="Twitter" class=" dark:hover:text-cyan-400">
                        ...
                        <a href="#" title="LinkedIn" class="dark:hover:text-cyan-400">
                        ...
                        <a href="#" title="GitHub" class="dark:hover:text-cyan-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32"
                                class="w-4 h-4">
                                <path
                ...
                <div
                    class="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-xl md:w-96 lg:w-80 xl:w-64 dark:bg-gray-900 dark:text-gray-300">
                    <img alt="" class="object-cover self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500"
                        src="{{ isset($user->photo_profile) ? asset('storage/' . $user->photo_profile) : 'https://dummyimage.com/200x200' }}">
                    <div class="flex-1 my-4">
                        <p class="text-xl font-semibold leading-snug">{{ $user->name }}</p>
...
{{-- <div class="flex flex-row flex-wrap-reverse justify-center mt-8">
    <div class="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
        <img alt="" class="self-center w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-coolGray-500" src="https://source.unsplash.com/100x100/?portrait">
        <div class="flex-1 my-4">
        ...
        <div class="flex items-center justify-center p-3 space-x-3 border-t-2">
            <a href="#" title="Email" class="dark:text-coolGray-900 hover:dark:text-sky-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                </svg>
            </a>
            <a href="#" title="Twitter" class="dark:text-coolGray-900 hover:dark:text-sky-400">
            ...
            <a href="#" title="LinkedIn" class="dark:text-coolGray-900 hover:dark:text-sky-400">
            ...
            <a href="#" title="GitHub" class="dark:text-coolGray-900 hover:dark:text-sky-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-5 h-5">
