            ...
            <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">News</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">World</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Games</a>
                        </li>
                        <li>
                            <a href="/"
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Media</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Brochure</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Nonprofit</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Educational</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Projects</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Infopreneur</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Personal</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Wiki</a>
                        </li>
                        <li>
                            <a href="/"
                                class="transition-colors duration-300 text-cyan-50 hover:text-teal-accent-400">Forum</a>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="flex flex-col justify-between pt-5 pb-10 border-t border-cyan-accent-200 sm:flex-row">
            ...
            <div class="flex items-center mt-4 space-x-4 sm:mt-0">
                ...
                <a href="https://www.instagram.com/rtik.bkl"
                ...
                <a href="https://m.facebook.com/relawantik.bangkalan.9"
                    class="transition-colors duration-300 text-cyan-100 hover:text-teal-accent-400">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
                        <path
