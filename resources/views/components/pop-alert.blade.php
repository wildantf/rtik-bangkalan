...
<div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-900">
    ...
    <div class="px-4 py-2 -mx-3">
        <div class="mx-3">
            <span class="font-semibold text-{{$color}}-500 dark:text-{{$color}}-400 capitalize">{{ $type }}</span>
